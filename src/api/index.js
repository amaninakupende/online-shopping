...
//切换产品勾选状态接口 /api/cart/checkCart/{skuID}/{isChecked} GET
...
//获取用户信息展示在home(需要带着用户的token向服务器请求) /api/user/passport/auth/getUserInfo
